...
import net.wagsn.util.function.Action;
...
public class PermissionRequestBuilder {
    ...
    private PermissionRequestBuilder(Object object) {
        mObject = object;
    }

    public static PermissionRequestBuilder with(@NonNull Activity activity) {
        return new PermissionRequestBuilder(activity);
    }

    public static PermissionRequestBuilder with(@NonNull Fragment fragment) {
        return new PermissionRequestBuilder(fragment);
    }

    public PermissionRequestBuilder permissions(@NonNull String... permissions) {
        mPermissions = permissions;
        return this;
    }

    public PermissionRequestBuilder result(@Nullable Result result) {
        mResult = result;
        return this;
    }

    public  PermissionRequestBuilder result(Action onGranted, Action onDenied){
        mResult = new Result() {
            @Override
